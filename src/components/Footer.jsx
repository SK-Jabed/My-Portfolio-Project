  ...
  return (
    <footer className="bg-gradient-to-b from-[#120820] via-[#1a0e30] to-[#120820] text-white">
      ...
      <div className="text-center py-8 px-4">
        <h2 className="text-3xl md:text-5xl font-exo font-bold text-violet-500">
          Thanks for Visiting!
        </h2>
        <p className="mt-3 font-nunito text-lg md:text-xl text-gray-300">
      ...
      <div className="border-t border-gray-700 pt-6 pb-4">
        <div className="container mx-auto px-6 flex flex-col items-center">
          {/* Logo */}
          <div className="text-3xl md:text-4xl font-lora font-semibold text-white">
            <a href="#" className="hover:text-gray-300 transition">
