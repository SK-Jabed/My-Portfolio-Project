    ...
    <footer className="bg-gradient-to-b from-[#120820] via-[#1a0e30] to-[#120820] text-white mt-0">
      ...
      <div className="border-t border-gray-700 pt-6 pb-4">
        <div className="container mx-auto px-6 flex flex-col items-center">
          ...
          {/* Footer Text */}
          <p
            className="mt-3 font-nunito text-center text-gray-300"
            data-aos="fade"
          >
            Built with ❤️ & ☕ by{" "}
          ...
          <div className="flex space-x-6 mt-5">
            {[
              {
                icon: FaTwitter,
                link: "https://x.com/Sheikh_Jabed_69",
                color: "text-blue-400",
              },
              {
                icon: FaGithub,
                link: "https://github.com/SK-Jabed",
                color: "text-gray-300",
              },
              {
                icon: FaLinkedin,
                link: "https://www.linkedin.com/in/sheikh-jabed-apu-072397350",
                color: "text-blue-500",
              },
              {
                icon: FaInstagram,
                link: "https://www.instagram.com/s_k_j_69/",
                color: "text-pink-400",
              },
