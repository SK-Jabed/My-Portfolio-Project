          ...
          <Fade direction="left">
            <div>
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                ...
                who loves creating dynamic and interactive digital experiences.
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                ...
                and bring ideas to life. I thrive in{" "}
          ...
          <Fade direction="right">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-nunito">
              ...
              {[
                {
                  title: "Experience",
                  text: "1+ years in full-stack development.",
                },
                {
                  title: "Technologies",
                  text: "React, Next.js, Tailwind, MongoDB, and more.",
                },
                {
                  title: "Hobbies",
                  text: "Coding, traveling, and exploring new tech.",
                },
                {
                  title: "Goal",
                  text: "To create impactful digital products.",
                },
              ].map((item, index) => (
                <div
                  key={index}
